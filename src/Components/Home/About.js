...
function About() {
  const handleres = () => {
    window.open(
      "https://drive.google.com/file/d/1Whg8z-PxZrCnbvMWCkhbrTZ4HOp_8mSy/view?usp=sharing",
    );
  };
  return (
      ...
      <Row>
        <Col md={8} className="home-about-description" id="user-detail-intro">
          <p className="home-about-body">
            Hi there! 👋, I'm full-stack web developer with a unique journey
            into the tech world 🤷‍♂️
            <br />
            ...
            <br />
            <br />
            While my educational background might not be in technology, my
            passion for creating &nbsp;
            <i>
              <b className="purple">
                digital experiences has been a driving force in my career{" "}
              </b>{" "}
              and relishing the art of creating engaging{" "}
          ...
          <a href="#contact">
            <Button id="resume-button-3">
              <CgPhone style={{ marginTop: "-4px", marginRight: "2px" }} />
              Contact
            </Button>
          </a>
        </Col>
