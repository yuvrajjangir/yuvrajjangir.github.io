  ...
  return (
    <div id="skills" className="allskills">
      <Container>
        ...
        <img style={{ width: "70%" }} src={html} className="skills-card-img" />
        <p className="skills-card-name" style={{ fontSize: "20px" }}>HTML</p>
      </div>
      <div className="skills-card">
        <img style={{width:"65%"}} src={css} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>CSS</p>
      </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={javascript} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Javascript</p>
      </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={nodejs} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Node</p>
        </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={react} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>React</p>
        </div>
      <div className="skills-card">
        <img style={{width:"110%",marginLeft:"-9px"}} src={mongodb} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Mongodb</p>
        </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={git} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Git</p>
        </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={firebase} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Firebase</p>
        </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={express} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Express</p>
        </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={redux} className="skills-card-img" />
        <p className="skills-card-name" style={{fontSize:"20px"}}>Redux</p>
        </div>
      <div className="skills-card">
        <img style={{width:"70%"}} src={java} className="skills-card-img" />
