...
function Github() {
  var initialURL =
    "https://github-readme-stats.vercel.app/api?username=yuvrajjangir&show_icons=true&hide_border=true&theme=synthwave";
  var initialURL2 =
    "https://github-readme-streak-stats.herokuapp.com?user=yuvrajjangir&theme=shades-of-purple&hide_border=true";
  ...
  function reloadStreakImage() {
    ...
    if (themeIndex !== -1) {
      ...
      img.src =
        urlWithoutTheme +
        "theme=shades-of-purple&hide_border=true&t=" +
        timestamp; // Reconstruct the URL with the timestamp
    } else {
  ...
  return (
    ...
    >
      ...
      <img
        src="https://github-readme-streak-stats.herokuapp.com?user=yuvrajjangir&theme=shades-of-purple&hide_border=true"
        id="github-streak-stats"
        className="stats"
        onMouseOver={reloadStreakImage}
        alt="git"
      />
      ...
      <img
        src="https://github-readme-stats.vercel.app/api/top-langs/?username=yuvrajjangir&layout=compact"
        id="github-top-langs"
        className="stats"
        alt="git"
      />
      ...
      <img
        src="https://github-readme-stats.vercel.app/api?username=yuvrajjangir&show_icons=true&hide_border=true&theme=synthwave"
        id="github-stats-card"
        className="stats"
        onMouseOver={reloadImage}
        alt="git"
      />
    </Row>
  );
